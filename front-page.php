...
<main id="top">
          ...
          <?php while ($the_query->have_posts()): $the_query->the_post(); ?>
            <div class="c-newslist_item">
              <a href="<?php the_permalink() ?>">
                <time class="c-newslist_time" datetime="<?php the_time('Y-m-d') ?>">
                  <?php the_time('Y.m.d') ?>
                </time>
                <div class="c-newslist_title">
                  <?php the_title() ?>
                </div>
              </a>
            </div>
  ...
  <section class="press" data-color="dark" data-fade>
    <div class="l-container">
      <div class="wrapper">
        <div class="wrapper_side">
          <h2 class="m-h2">
  ...
  <section class="interview" data-color="dark" data-fade>
    <div class="l-container">
      <div class="wrapper">
        <div class="wrapper_side">
          <h2 class="m-h2">
  ...
  <section class="schedule" data-color="dark" data-fade>
    <div class="l-container">
      <div class="wrapper">
        <div class="wrapper_side">
          <h2 class="m-h2">
        ...
        <div class="wrapper_content">
          <div class="schedule_calender">
            ...
            <div class="schedule_month">
              <h4>
                <span class="en">
                  <?php echo get_post_time('F'); ?> <?php echo wp_date( 'Y' ); ?>
                </span><br>
                <span class="jp">
                  <?php echo wp_date( 'F' ); ?>
                </span>
  ...
  <section class="links" data-color="light" data-fade>
    <div class="l-container">
